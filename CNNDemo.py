...
def conv2d(x, W):
    #输入参数解释
    #x input tensor of shape '[batch, in_height, in_width, in_channels]'in_channels表示通道数，1表示是黑白的，3表示是RBG
...
with tf.name_scope('Conv1'):
    ...
    with tf.name_scope("conv2d_1"):
        conv2d_1 = conv2d(x_image, W_conv1) +b_pool1
...
#一张28*28的图片第一次卷积后还是28*28，第一次池化后变成14*14
...
with tf.name_scope("fc1"):
    ...
    with tf.name_scope("h_fc1_drop"):
        h_fc1_drop = tf.nn.dropout(h_fc1, keep_prob, name="h_fc1_drop")#优化全连接，试全连接神经元中一部分工作，一部分不工作
